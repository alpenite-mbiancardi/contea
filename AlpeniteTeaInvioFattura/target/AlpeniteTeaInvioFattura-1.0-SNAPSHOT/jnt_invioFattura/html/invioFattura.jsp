				...
				<div class="main" style="width:905px">
				    <form id="formInvioFatture" action="<c:url value='${url.base}${currentNode.path}'/>.invioFattura.do" method="post">
						<div class="ctn-data pag" style="width:98%;margin-left: 2%;">
							...
							<h3>Adesione Firma Elettronica Avanzata</h3>
...
<tr>
											...
											<td class="colonna"style="width:200px">${rigaD.data}</td>
											<td class="colonna download">
<c:if test="${rigaD.estensione=='pdf'}">
										<a href="/scaricaDocumento.jsp?n=${rigaD.arcDocId}&t=${rigaD.sapObject}&name=${rigaD.definizioneIt}.pdf" class="download link1" target="_blank"><b>Download</b></a> 
										</c:if>
										<c:if test="${rigaD.estensione=='MP3'}">
										<a href="/scaricaDocumento.jsp?n=${rigaD.arcDocId}&t=${rigaD.sapObject}&name=${rigaD.definizioneIt}.mp3" class="download link1" target="_blank"><b>Download</b></a> 
										</c:if>
</td></tr>
										</tbody>
									</table>
...
<tr>
											...
											<td class="colonna" style="width:140px">${rigaD.estensione}</td>
											<td class="colonna" style="width:200px">${rigaD.data}</td>
											<td class="colonna download"><c:if test="${rigaD.estensione=='pdf'}">
										<a href="/scaricaDocumento.jsp?n=${rigaD.arcDocId}&t=${rigaD.sapObject}&name=${rigaD.definizioneIt}.pdf" class="download link1" target="_blank"><b>Download</b></a> 
										</c:if>
										<c:if test="${rigaD.estensione=='MP3'}">
										<a href="/scaricaDocumento.jsp?n=${rigaD.arcDocId}&t=${rigaD.sapObject}&name=${rigaD.definizioneIt}.mp3" class="download link1" target="_blank"><b>Download</b></a> 
