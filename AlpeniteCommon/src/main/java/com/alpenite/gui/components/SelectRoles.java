...
public class SelectRoles {
     ...
     */
    public SelectRoles(String nome, String id, Map<String, String> attributi) throws IOException {
        this.nome = nome;
        this.id = id;
     ...
     * @param attributi la mappa attributo=valore da associare al campo
     */
    public SelectRoles(Map<String, String> attributi) throws IOException {
     ...
     * elenco delle province
     */    
    public SelectRoles() throws IOException {
        this(null);
    }
    ...
    public static String PATH_FILE_COUNTRIES = "roles.ini";
    
    /** il nome predefinito del campo */
    public static String NAME_PREDEFINITO = "ruolo";
    
    /** l'id predefinito del campo */
    public static String ID_PREDEFINITO = "ruolo";
    ...
    public String toString() {
        ...
        TreeSet<String> prov = new TreeSet<String>(roles.stringPropertyNames());
        for(String provincia: prov) {
            String valore = provincia;
            String nomeValore = ""+roles.getProperty(valore);
    ...
    public List<String> getRoles(){
    	...
    	TreeSet<String> roles_tree = new TreeSet<String>(roles.stringPropertyNames());
    	for(String role : roles_tree){
    		list.add(role);
    	}
    	return list;
    }
