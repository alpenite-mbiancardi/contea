 ...
 */
public class SelectFirstLevelReqProspect extends SelectComponent {
     ...
     */
    public SelectFirstLevelReqProspect(String nome, String id, Map<String, String> attributi) throws IOException {
     ...
     * @param attributi la mappa attributo=valore da associare al campo
     */
    public SelectFirstLevelReqProspect(Map<String, String> attributi) throws IOException {
     ...
     * elenco delle province
     */    
    public SelectFirstLevelReqProspect() throws IOException {
        this(null);
    }
    
    /** costante con il nome del file che contiene la lista delle province */
    public static String PATH_FILE_PROVINCE = "firstLevelReqProspect.ini";
