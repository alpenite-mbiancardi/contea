 ...
 *         &lt;element name="EtSr" type="{urn:sap-com:document:sap:soap:functions:mc-style}ZptTtSr"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ZptSrListResponse")
public class ZptSrListResponse {
    ...
    @XmlElement(name = "EtSr", required = true)
    protected ZptTtSr etSr;
    ...
    /**
     * Gets the value of the etSr property.
     * 
     * @return
     *     possible object is
     *     {@link ZptTtSr }
     *     
     */
    public ZptTtSr getEtSr() {
        return etSr;
    }

    /**
     * Sets the value of the etSr property.
     * 
     * @param value
     *     allowed object is
     *     {@link ZptTtSr }
     *     
     */
    public void setEtSr(ZptTtSr value) {
        this.etSr = value;
    }
