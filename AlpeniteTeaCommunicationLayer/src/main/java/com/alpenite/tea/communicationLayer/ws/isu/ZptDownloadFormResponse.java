 ...
 *         &lt;element name="EtMess" type="{urn:sap-com:document:sap:rfc:functions}ZPT_TT_MESS"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ZptDownloadFormResponse")
public class ZptDownloadFormResponse {
