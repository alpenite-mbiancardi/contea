 ...
 *         &lt;element name="ESapType" type="{urn:sap-com:document:sap:soap:functions:mc-style}char1"/>
...
@XmlRootElement(name = "ZptBpTypeGetResponse")
public class ZptBpTypeGetResponse {

    @XmlElement(name = "EReturn", required = true)
    protected String eReturn;
    @XmlElement(name = "ESapType", required = true)
    protected String eSapType;
    ...
    /**
     * Gets the value of the eSapType property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getESapType() {
        return eSapType;
    }

    /**
     * Sets the value of the eSapType property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setESapType(String value) {
        this.eSapType = value;
    }
