 ...
 *         &lt;element name="EtLett" type="{urn:sap-com:document:sap:soap:functions:mc-style}ZptTtLett"/&gt;
...
@XmlRootElement(name = "ZptLettureSvuotamentiResponse")
public class ZptLettureSvuotamentiResponse {

    @XmlElement(name = "EReturn", required = true)
    protected String eReturn;
    @XmlElement(name = "EtLett", required = true)
    protected ZptTtLett etLett;
    ...
    /**
     * Recupera il valore della proprietà etLett.
     * 
     * @return
     *     possible object is
     *     {@link ZptTtLett }
     *     
     */
    public ZptTtLett getEtLett() {
        return etLett;
    }

    /**
     * Imposta il valore della proprietà etLett.
     * 
     * @param value
     *     allowed object is
     *     {@link ZptTtLett }
     *     
     */
    public void setEtLett(ZptTtLett value) {
        this.etLett = value;
    }
