 ...
 *         &lt;element name="EtCity" type="{urn:sap-com:document:sap:soap:functions:mc-style}ZptTtComuni"/&gt;
...
@XmlRootElement(name = "ZptReadComuneResponse")
public class ZptReadComuneResponse {

    @XmlElement(name = "EReturn", required = true)
    protected String eReturn;
    @XmlElement(name = "EtCity", required = true)
    protected ZptTtComuni etCity;
    ...
    /**
     * Recupera il valore della proprietà etCity.
     * 
     * @return
     *     possible object is
     *     {@link ZptTtComuni }
     *     
     */
    public ZptTtComuni getEtCity() {
        return etCity;
    }

    /**
     * Imposta il valore della proprietà etCity.
     * 
     * @param value
     *     allowed object is
     *     {@link ZptTtComuni }
     *     
     */
    public void setEtCity(ZptTtComuni value) {
        this.etCity = value;
    }
