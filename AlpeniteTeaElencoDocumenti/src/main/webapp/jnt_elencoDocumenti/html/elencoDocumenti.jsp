...
if(importoAperto1 >0) {
	...
	System.out.println("bottonePagamento "+bottonePagamento);
	...
	if(importoMaggioreZero == true && isFattura==true && bottonePagamento == true ) {
		...
		String tid ="", kSig ="";
		System.out.println(codCompagnia);
		System.out.println(dataEmiss);
		...
		if(!idTransazione.equals("")){
			...
			String[] parts = idTransazione.split("-");
                                                ...
                                                if(tipoPag.contains("M")) {
                                    				//mybank
                                    				if(codCompagnia.equals("Z022")|| codCompagnia.equals("YL22") || codCompagnia.equals("YE22") || codCompagnia.equals("YT22")) {
                                    					//TEA ENERGIA
                                    					 tid= "30363580";
                                    					 kSig= "4e7c4e9c0c6c5h0j0j0f4e7c4e9j0j0f";
                                    				};
                                    				if(codCompagnia.equals("Z023")){
                                    					//MANTOVA AMBIENTE
                                    					 tid= "30363732";
                                    					 kSig= "4e7c4f0c0c6c7c2j0j0f4e7c4f0j0j0f";
                                    				};

                                    				if(codCompagnia.equals("Z025")){
                                    					//TEA ACQUE
                                    					 tid= "30363749";
                                    					 kSig= "4e7c4f2c0c6c7d9j0j0f4e7c4f2j0j0f";
                                    				};

                                    				if(codCompagnia.equals("Z031")){
                                    					//TEA AQA
                                    					 tid= "30363745";
			...
			String serverURL="https://pagamenti.unicredit.it/UNI_CG_SERVICES/services";
			int timeout  = 15000;
			...
			System.out.println(numeroOrdine);
		...
		if(visualBottonePagamento) {
			...
			<!--<h1>Pagamenti online al momento non disponibili</h1>-->
		...
		$( "#popup${riga.numeroFattura}<%=n%>" ).click(function() {
			...
			modal: true,
			open : function() {
				$('#dialog${riga.numeroFattura}<%=n%>').scrollTop(0);
			}
