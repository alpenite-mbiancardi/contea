package com.alpenite.tea.datiAnagraficiAzienda;
...
public class SendDatiAnagraficiAzienda extends Action {

	private transient static Logger logger = org.slf4j.LoggerFactory.getLogger(SendDatiAnagraficiAzienda.class);
    ...
    public ActionResult doExecute(HttpServletRequest req, RenderContext renderContext, Resource resource, JCRSessionWrapper session, Map<String, List<String>> parameters, URLResolver urlResolver) throws Exception {
        ...
        DatiAnagrafici datiAnagraficiOld = new DatiAnagrafici(
                ...
                (getParameter(parameters, "ncivicoExtOld") != null ) ? getParameter(parameters, "ncivicoOld") : "",
     ...
     // tel
        ...
        //TODO put in the form the old datas and set it here
        //DatiAnagrafici datiAnagraficiOld = null;
        datiAnagrafici.setEstenzioneNumeroCivico(extncivico);
        logger.info("Verifica Dati Utente :"+datiAnagrafici.getEstenzioneNumeroCivico() );
        String srRequest = "SR";
        WSClient client;
        try {
        ...
        return new ActionResult(HttpServletResponse.SC_ACCEPTED,(session.getNodeByIdentifier(parameters.get("conferma1").get(0))).getPath());
    }
