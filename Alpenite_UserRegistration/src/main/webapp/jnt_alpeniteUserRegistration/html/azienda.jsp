...
<div class="informationContainer">
		...
		<tr>
		<td>
		<label for="ragione_sociale"><fmt:message key="ragione_sociale"/></label>
		</td>
		<td>
		<input type="text" name="ragione_sociale" id="ragione_sociale" value="${sessionScope.formDatas['ragione_sociale'][0]}"/>
		</td>
		<td>
