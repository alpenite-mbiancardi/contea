	...
	<%while(iterUserList.hasNext()){
		...
		%>	 		
			<tr class="riga">
				...
				<td class="bg colonna"><%=user.getProperty("j:email") %></td>
...
//uppercase email 
try {
if(user.getProperty("j:email")!=null) {
String emailU = user.getProperty("j:email");
char a =   emailU.charAt(0);
...
int charType = Character.getType(a);
		...
		user.setProperty("j:email",emailU.toUpperCase());
	}
}
} catch (Exception e) {
